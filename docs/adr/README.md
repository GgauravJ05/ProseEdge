...
| #                                                         | Title                                                          | Status                                                       |
| :-------------------------------------------------------- | :------------------------------------------------------------- | :----------------------------------------------------------- |
| [0001](0001-toolchain-and-delivery.md)                    | Toolchain and delivery process                                 | Accepted (visibility superseded by 0012, deployment by 0008) |
| [0002](0002-document-grammar-and-provenance.md)           | Document grammar ordering, separators and provenance           | Accepted                                                     |
| [0003](0003-private-repository.md)                        | Private repository on a free plan                              | Superseded by 0012                                           |
...
| [0012](0012-public-repository.md)                         | Public repository again                                        | Accepted                                                     |
