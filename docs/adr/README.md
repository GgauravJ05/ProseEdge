...
| #                                               | Title                                                | Status                                                       |
| :---------------------------------------------- | :--------------------------------------------------- | :----------------------------------------------------------- |
| [0001](0001-toolchain-and-delivery.md)          | Toolchain and delivery process                       | Accepted (visibility superseded by 0003, deployment by 0004) |
...
| [0004](0004-deploy-to-vercel.md)                | Deploy to Vercel from GitHub Actions                 | Accepted                                                     |
